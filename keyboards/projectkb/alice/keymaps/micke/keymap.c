...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_alice_split_bs(
    ...
    KC_PGDN, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             ...
             MO(_FN2),         KC_LGUI, KC_SPC,  KC_LALT,                           KC_SPCF,          KC_RALT,          KC_RGUI
  ),
  ...
  [_FN] = LAYOUT_alice_split_bs(
    ...
    RGB_RMOD, _______, _______, _______, _______, _______, _______,          _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          _______,
  ...
  [_FN2] = LAYOUT_alice_split_bs(
    ...
    _______,  _______, _______, _______, _______, _______, _______,          _______, KC_MRWD, KC_VOLD, KC_VOLU, KC_MFFD, KC_MPLY,          _______,
              _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,
              _______,          _______, _______, _______,                            _______,          _______,          _______
  ),
};
